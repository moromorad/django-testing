...
@shared_task
def fetch_weather_and_cleanup():
    url = "https://api.open-meteo.com/v1/forecast?latitude=30.0626&longitude=31.2497&current=temperature_2m,weather_code&timezone=Africa%2FCairo"
    ...
    weather_desc = get_weather_category(weathercode)
